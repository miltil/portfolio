...
const PatientInfo = ({ onClick, selected, patientProfile: { name, gender, dob, email, phone } }) => (
    <div onClick={onClick} className={`flex gap-4 pt-2 pr-1.5 pb-4 pl-4 rounded-md border-solid cursor-pointer w-full ${selected ? "border-[color:var(--color-secondary)] border-[3px]" : "border-[color:var(--color-neutral-gray)] border-[1px]"}`}>
